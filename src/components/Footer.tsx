        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/category/aviator-glasses" className="text-white/70 hover:text-white transition-colors">Aviator Glasses</Link></li>
              <li><Link to="/category/pilot-watches" className="text-white/70 hover:text-white transition-colors">Pilot Watches</Link></li>
              <li><Link to="/category/flight-gear" className="text-white/70 hover:text-white transition-colors">Flight Gear</Link></li>
              <li><Link to="/category/accessories" className="text-white/70 hover:text-white transition-colors">Accessories</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/warranty" className="text-white/70 hover:text-white transition-colors">Warranty</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/our-story" className="text-white/70 hover:text-white transition-colors">Our Story</Link></li>
        ...
        <div className="border-t border-white/10 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              <Link to="/" className="text-2xl font-bold">SKYWARD</Link>
              <p className="text-sm text-white/60 mt-2">
                © {new Date().getFullYear()} Skyward Aviation. All rights reserved.
              </p>
            </div>
